...
class UsageStatsUniqueItemInvestigationsTemporaryRecordDAO
{
    ...
    public $table = 'usage_stats_unique_item_investigations_temporary_records';
     ...
     * ]
     */
    public function insert(object $entryData, int $lineNumber, string $loadId)
    {
    ...
    public function loadMetricsSubmissionGeoDaily(string $loadId)
    {
