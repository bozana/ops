...
/**
* @file classes/statistics/IR.inc.php
*
...
class IR
{
    ...
    /** Platform name is alwas the context primary locale name */
    ...
    public const PARENT_DATA_TYPE = 'Repository';
    ...
    public function getReportItems(): array
    {
        ...
        if (empty($results)) {
            $this->exceptions[] = [
                ...
                'Data' => __('sushi.exception.3030', ['beginDate' => $beginDate, 'endDate' => $endDate])
            ];
        }
